...
SOL paragraphs: P65
Korean lines: 133
Terminology alert: `자하신공` → `Zaha Divine Technique` present in BASE, absent from SOL.
...
SOL paragraphs: P137
Korean lines: 281
Terminology alert: `청풍` → `Cheongpung` present in BASE, absent from SOL.
...
SOL paragraphs: P148
Korean lines: 303
Terminology alert: `혁무진` → `Hyuk Mujin` present in BASE, absent from SOL.
...
### H126 — insert
Baseline paragraphs: after P230
SOL paragraphs: P230
Korean lines: 475
...
Return exactly the JSON object required by the adjudicator brief, with chapter set to 153 and exactly one decision for each of the 155 hunks.
