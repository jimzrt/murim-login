...
SOL paragraphs: P118
Korean lines: 245
Terminology alert: `북망산` → `Mount Beimang` present in BASE, absent from SOL.
...
Return exactly the JSON object required by the adjudicator brief, with chapter set to 117 and exactly one decision for each of the 100 hunks.
